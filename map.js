...
//////////////////////////////////////////////////////////////////////////////////////////
const map = L.map('map').setView([35.137143, 136.976502], 18)     // https://leafletjs.com/reference.html#map-example を参照
    ...
    allLocationsData.forEach(data => {
        ...
        if (areaMatch && districtMatch) {
            ...
            // マーカーにポップアップコンテンツを紐付け
                            .bindPopup(popupContent)     // https://leafletjs.com/reference.html#layer-bindpopup を参照
            // マーカーを地図に配置
                            .addTo(map);     // https://leafletjs.com/reference.html#marker を参照
